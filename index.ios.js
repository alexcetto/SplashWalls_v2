...
class SplashWalls extends Component {
  ...
  saveCurrentWallpaperToCameraRoll(){
    ...
    var promise = CameraRoll.saveToCameraRoll(currentWallURL);
    promise.then(function(data) {
      ...
      AlertIOS.alert(
        ...
        'Image was not saved',
        [
          {text:"Error !", onPress: () => console.log("Button pressed")}
        ]
      );
    });
  }
...
AppRegistry.registerComponent('SplashWalls_v2', () => SplashWalls);
